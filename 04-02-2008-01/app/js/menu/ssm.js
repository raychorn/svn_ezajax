...
function makeStatic() {
try {
if (NS||NS6) {winY = (window.pageYOffset)?(window.pageYOffset):(document.documentElement)?document.documentElement.scrollTop:document.body.scrollTop;}
...
function buildMenu(imgName) {
imgName = ((typeof imgName) == 'string' ? imgName : ' ');
...
document.write('<TD BGCOLOR="'+linkBGColor+'" onmouseover="bgColor=\''+linkOverBGColor+'\'" onmouseout="bgColor=\''+linkBGColor+'\'" WIDTH="'+ssmItems[i][5]+'px" COLSPAN="'+ssmItems[i][3]+'"><ILAYER><LAYER onmouseover="bgColor=\''+linkOverBGColor+'\'" onmouseout="bgColor=\''+linkBGColor+'\'" WIDTH="100%" ALIGN="'+linkAlign+'"><DIV  ALIGN="'+linkAlign+'"><FONT face="'+linkFontFamily+'" Size="'+linkFontSize+'">&nbsp;<A HREF="'+ssmItems[i][1]+'" target="'+ssmItems[i][2]+'" CLASS="ssmItems" onclick="try { handleOnClickSsmItems('+i+'); } catch(e) { }; return true;">'+ssmItems[i][0]+'</A><div id="div_anchor_ssmItems_'+i+'" style="display: none;"><img src="'+imgName+'checkOn.gif"></div></DIV></LAYER></ILAYER></TD>')}
