		...
		<cfloop index="aURL" list="#arguments.pingurls#">
			...
			<cftry>
				<cfif aURL is "@technorati">
					...
					<cflog file="#Application.ApplicationName#" type="Information" text="pingTechnorati(#arguments.blogTitle#, #arguments.blogURL#) [#Now()#]">
				<cfelseif aURL is "@weblogs">
					<cfset pingweblogs(arguments.blogTitle, arguments.blogURL)>
					<cflog file="#Application.ApplicationName#" type="Information" text="pingweblogs(#arguments.blogTitle#, #arguments.blogURL#) [#Now()#]">
				<cfelseif aURL is "@icerocket">
					<cfset pingIceRocket(arguments.blogTitle, arguments.blogURL)>
					<cflog file="#Application.ApplicationName#" type="Information" text="pingIceRocket(#arguments.blogTitle#, #arguments.blogURL#) [#Now()#]">
				<cfelse>
					<cfhttp url="#aURL#" method="GET" resolveurl="false">
					<cflog file="#Application.ApplicationName#" type="Information" text="Ping URL (#aURL#) [#Now()#]">
				</cfif>
	
				<cfcatch type="Any">
					<cfif isDebugMode()>
						<cfdump var="#cfcatch#" label="pingAggregators - ERROR" expand="No">
					</cfif>
				</cfcatch>
			</cftry>
		</cfloop>
